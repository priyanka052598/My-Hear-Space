  ...
  const listeners = [
    {
      ...
      reviews: 20,
      experience: "150 Hrs",
      description: "I ha ve served the on in the lorem45ve served the nation in the lorem45ve served the nation in the lorem45 served the nation in the lorem45Indian Navy for 35 years...",
      image: "profile.png",
    },
...
//     </div>
<div className={`cards  ${isLgScreen ? "pt-0" : "pt-20" } flex flex-wrap justify-center gap-[24px]`}>
